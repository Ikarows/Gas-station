...
<body>
	...
	<div class="container">
		<div class="screening">
			<ul class="type-tab">
				<li class="<?php if($_GET['type'] == 'gasoline'){ echo 'active';} ?>" onclick="getData('<?php echo "$qyUrl" ?>')">汽油</li>
				<li class="<?php if($_GET['type'] == 'diesel'){ echo 'active';} ?>" onclick="getData('<?php echo "$cyUrl" ?>')">柴油</li>
				<li class="<?php if($_GET['type'] == 'cng'){ echo 'active';} ?>" onclick="getData('<?php echo "$cngUrl" ?>')">CNG</li>
				<li class="<?php if($_GET['type'] == 'lng'){ echo 'active';} ?>" onclick="getData('<?php echo "$lngUrl" ?>')">LNG</li>
				<div class="clear"></div>
			</ul>
			<ul class="daybtn-box">
